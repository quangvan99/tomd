...
from qmd.model.ocr.seal_crop import CropByPolys, SortPolyBoxes
from qmd.utils.config_reader import get_device
from qmd.utils.enum_class import ModelPath
from qmd.utils.models_download_utils import auto_download_and_get_model_root_path
from qmd.utils.ocr_utils import (
    check_img,
    preprocess_image,
    sorted_boxes,
    merge_det_boxes,
...
from qmd.model.utils.tools.infer.predict_system import TextSystem
from qmd.model.utils.tools.infer import pytorchocr_utility as utility
import argparse

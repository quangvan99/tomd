...
from qmd_vl_utils import MinerUClient
from qmd_vl_utils.structs import BlockType
from tqdm import tqdm

from qmd.backend.hybrid.hybrid_model_output_to_middle_json import (
    append_page_model_list_to_middle_json,
    finalize_middle_json,
    init_middle_json,
)
from qmd.backend.utils.runtime_utils import exclude_progress_bar_idle_time
from qmd.backend.pipeline.model_init import HybridModelSingleton
from qmd.backend.vlm.vlm_analyze import (
    ModelSingleton,
    aio_predictor_execution_guard,
    predictor_execution_guard,
    _maybe_enable_serial_execution,
)
from qmd.data.data_reader_writer.base import DataWriter
from qmd.utils.config_reader import get_device, get_processing_window_size
from qmd.utils.enum_class import ImageType, NotExtractType
from qmd.utils.model_utils import crop_img, get_vram, clean_memory
from qmd.utils.ocr_utils import get_adjusted_mfdetrec_res, get_ocr_result_list, sorted_boxes, merge_det_boxes, \

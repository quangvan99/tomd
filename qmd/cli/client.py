...
from qmd.cli.visualization import (
    VisualizationJob,
    ...
    async with httpx.AsyncClient(timeout=timeout, follow_redirects=True) as http_client:
        try:
            if api_url is None:
                ...
                logger.info(f"Started local qmd-api at {base_url}")
...
@click.option(
    ...
    type=str,
    default=None,
    help="MinerU FastAPI base URL. If omitted, qmd starts a temporary local qmd-api service.",
)
@click.option(
    "-m",
    "--method",
